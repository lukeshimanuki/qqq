...
from mover_library.utils import get_place_domain, set_robot_config, CustomStateSaver, get_body_xytheta, visualize_path, \
    are_base_confs_close_enough
from mover_library.motion_planner import find_prm_path, init_prm
...
class IsReachable(UnaryPredicate):
    ...
    def precompute(self):
        ...
        init_prm()
        from mover_library.motion_planner import prm_vertices
